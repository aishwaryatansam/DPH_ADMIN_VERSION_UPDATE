            ...
            <div class="d-flex justify-content-between align-items-center" style="padding-left: 20px; padding-right: 20px;">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0" style="background-color: #f2f2f2;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create AboutUs</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="container-fluid mt-2">
                    <div class="col-lg-12 p-5" style="background-color: #ffffff; border-radius: 10px;">
                        <form action="{{ route('about-us.store') }}" enctype="multipart/form-data" method="post">
                            {{ csrf_field() }}
                            <h4 class="card-title mb-4 text-primary">Create AboutUs</h4>
                            ...
                            <div class="d-grid gap-3 mb-3 grid-3 grid-2 grid-1">
                                ...
                                <div>
                                    ...
                                    <select name="submenu_id" id="content_type" class="form-select">
                                ...
                                <div id="thumbnail_div"> <!-- Smaller width for Thumbnail -->
                                    <label for="Thumbnail" class="form-label">Thumbnail<span
                                            style="color: red;">*</span></label>
                                    <input type="text" class="form-control" id="Thumbnail" placeholder="Enter Title"
                                        name="thumbnail_name">
                                </div>
                                ...
                                <div id="souvenir_div"> <!-- Adjusted width for souvenir -->
                                    <label for="souvenir" class="form-label">Souvenir <span
                                            style="color: red;">*</span></label>
                                    <input type="text" class="form-control" id="souvenir" placeholder="Enter Title"
                                        name="souvenir_name">
                                </div>
                            ...
                            {{-- <div class="col-md-4">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="toggleVisibleToPublic" 
                                    {{ CHECKBOX('document_status') }} name="visible_to_public"
                                    value="1" onchange="toggleVisibilityText('publicStatusLabel', this)">
                                            ...
                                            <form action="{{ route('testimonials.store') }}" method="POST"
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <button type="button" class="btn btn-danger"
                                                        style="margin-left: 10px;" data-bs-dismiss="modal">Cancel</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
