                    ...
                    <div class="row">
                        <div class="col-lg-12 p-5" style="background-color: #ffffff; border-radius: 10px;">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('designations.update', $result->id) }}" enctype="multipart/form-data"
                                    method="post">
                                    {{ csrf_field() }}
                                    @method('PUT')
                                    <div class="row mb-3 p-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="Designationtype" name="name"
                                    ...
                                    <div class="row mb-3 p-3">
                                        <div class="col-md-6">
                                            ...
                                            <select name="designation_type_id" id="designation_type_id"
                                                class="form-control">
                                                <option value="">-- Select Designation Type-- </option>
                                                @foreach ($designation_types as $key => $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ SELECT($value->id, $result->designation_type_id) }}>
                                                        {{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="text-start mt-4">
                                        ...
                                        <a type="button" class="btn btn-danger"
                                            href="{{ route('designations.index') }}">Cancel</a>
                                    </div>
                                </form>
                            </div>
