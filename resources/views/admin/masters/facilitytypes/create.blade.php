            ...
            <div class="d-flex justify-content-between align-items-center" style="padding-left: 20px; padding-right: 20px;">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0" style="background-color: #f2f2f2;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create Facility Type</li>
                    </ol>
                </nav>
                ...
                <div class="container mt-2">
                    <div class="row">
                        <div class="col-lg-8 p-5" style="background-color: #ffffff; border-radius: 10px;">
                            <form id="contactForm" action="{{route('facilitytypes.store')}}" enctype="multipart/form-data" method="post">
                                {{csrf_field()}}
                                <div class="container">
                                    <h4 class="card-title mb-4 text-primary">Create Facility Type</h4>
                                ...
                                <div class="d-flex mt-2 pl-5">
                                    ...
                                    <a type="button" href="{{route('facilitytypes.index')}}" style="margin-left: 10px;" class="btn btn-danger" >Cancel</a>
                                </div>
                            </form>
