            ...
            <div class="d-flex justify-content-between align-items-center" style="padding-left: 20px; padding-right: 20px;">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0" style="background-color: #f2f2f2;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">List Submenu</li>
                    </ol>
                </nav>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title mb-4 text-primary">All Submenu</h4>
                                        <!-- Button to add employees if needed -->
                                        <button class="btn btn-primary btn-round ms-auto"
                                            onclick="window.location.href='{{ route('submenu.create') }}';">
                                                        ...
                                                        <td class="text-center">
                                                            <div class="form-button-action">
                                                                <button type="button"
                                                                    ...
                                                                    onclick="window.location.href='{{ route('submenu.edit', $result->id) }}'"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#downloadBtn').on('click', function() {
                ...
                XLSX.utils.book_append_sheet(wb, ws, 'Submenu');

                // Set the filename
                var filename = 'submenu-list-' + new Date().toLocaleDateString('en-GB').replace(/\//g, '-') + '.xlsx';
