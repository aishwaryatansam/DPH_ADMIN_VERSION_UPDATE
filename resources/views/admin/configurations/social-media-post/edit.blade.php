    ...
    <div class="container" style="margin-top: 90px;">
        <div class="container-fluid p-2" style="background-color: #f2f2f2;">
            <div class="d-flex justify-content-between align-items-center" style="padding-left: 20px; padding-right: 20px;">
                <h5 class="mb-0">Edit Social Media Post</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0" style="background-color: #f2f2f2;">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Social Media Post</li>
                    </ol>
                </nav>
                    ...
                    <div class="container mt-2">
                        <div class="row">
                            <div class="col-lg-12 p-5" style="background-color: #ffffff; border-radius: 10px;">
                                <form id="myForm" action="{{ route('social-media-post.update', $result->id) }}"
                                    enctype="multipart/form-data" method="post">
                                    {{ csrf_field() }}
                                    @method('PUT')
                                    <div class="container">
                                        <h4 class="card-title mb-4 text-primary">Edit Social Media Post</h4>

                                        <!-- Name Row -->
                                        <div class="row mb-3">
                                            <!-- Label Column with reduced width -->
                                            <div class="col-12 col-md-3">
                                                <label for="name" class="form-label">Social Media Type <span
                                                        class="sizeoftextred">*</span></label>
                                            </div>
                                            <!-- Input Column -->
                                            <div class="col-12 col-md-7">
                                                <select class="form-control" id="platform" name="name">
                                                    <option value="" disabled selected>Select a platform</option>
                                                    @foreach (getSocialMediaType() as $key => $type)
                                                        <option value="{{ $key }}"
                                                            data-value="{{ $type }}"
                                                            {{ SELECT($key, $result->name) }}>
                                                            {{ $type }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            <!-- Label Column with reduced width -->
                                            <div class="col-12 col-md-3">
                                                <label for="name" class="form-label">Menu to show<span
                                                        class="sizeoftextred">*</span></label>
                                            </div>
                                            <!-- Input Column -->
                                            <div class="col-12 col-md-7">
                                                <select class="form-control" id="platform" name="menu_to_show">
                                                    <option value="" disabled selected>Select a platform</option>
                                                    @foreach (getMenuToShow() as $key => $type)
                                                        <option value="{{ $key }}"
                                                            data-value="{{ $type }}"
                                                            {{ SELECT($key, $result->menu_to_show) }}>
                                                            {{ $type }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-7">
                                                <input type="file" class="form-control" name="social_media_post_image"
                                    ...
                                    <div class="d-flex mt-2 pl-5">
                                        ...
                                        <button type="button" style="margin-left: 10px;"
                                            onclick="window.location.href='{{ url('/social-media-post') }}';"
