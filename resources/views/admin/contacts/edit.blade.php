                ...
                <div class="container-fluid mt-2">
                    <div class="row">
                        <div class="col-lg-12 py-5 px-5" style="background-color: #ffffff; border-radius: 10px;">
                            <form id="contactForm" action="{{ route('contacts.update', $result->id) }}" enctype="multipart/form-data"
                                method="post">
                                {{ csrf_field() }}
                                @method('PUT')
                                ...
                                <div class="container">
                                    ...
                                    <div class="d-grid gap-5 mb-3 grid-3 grid-2 grid-1">
                                        <!-- Contact Type Row -->
                                            ...
                                            <select name="facility_type" id="facility_type" class="form-select">
                                                ...
                                                @foreach ($facility_types as $key => $value)
                                                    <option value="{{ $value->id }}" data-value="{{ $value->slug_key }}"
                                                        {{ SELECT($value->id, $result->facility->facility_type_id ?? '') }}>{{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                            ...
                                            <select name="hud_id" id="hud_id" class="form-control">
                                                ...
                                                @foreach ($huds as $key => $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ SELECT($value->id, $result->facility->hud_id ?? '') }}>{{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div>
                                            ...
                                            <select name="block_id" id="block_id" class="form-control">
                                                ...
                                                @foreach ($blocks as $key => $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ SELECT($value->id, $result->facility->block_id ?? '') }}>{{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div>
                                            ...
                                            <select name="phc_id" id="phc_id" class="form-control">
                                                ...
                                                @foreach ($phc as $key => $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ SELECT($value->id, $result->facility->phc_id ?? '') }}>{{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select name="hsc_id" id="hsc_id" class="form-control">
                                                ...
                                                @foreach ($hsc as $key => $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ SELECT($value->id, $result->facility->hsc_id ?? '    ') }}>{{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select name="facility_id" id="facility_id" class="form-select">
                                                ...
                                                @foreach ($facilities as $key => $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ SELECT($value->id, $result->facility_id) }}>{{ $value->facility_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select name="programs_id" id="program_id" class="form-select">
                                                ...
                                                @foreach ($programs as $key => $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ SELECT($value->id, $result->programs_id) }}>{{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" name="order_no" class="form-control" id="order_no"
                                                placeholder="Enter Order No" value="{{ $result->order_no }}">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select name="contact_type" id="contact_type" class="form-select">
                                                ...
                                                @foreach ($contact_types as $key => $value)
                                                    <option value="{{ $value->id }}" data-value="{{ $value->slug_key }}"
                                                        {{ SELECT($value->id, $result->contact_type) }}>{{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div id="designation_div">
                                            ...
                                            <select name="designation_id" id="designation_id" class="form-control">
                                                ...
                                                @foreach ($designation as $key => $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ SELECT($value->id, $result->designation_id) }}>
                                                        {{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div id="qualification_div">
                                            ...
                                            <input type="text" name="qualification" name="qualification" class="form-control" id="qualification"
                                                placeholder="Enter Qualification" value="{{ $result->qualification }}">
                                        </div>

                                        {{-- <!-- Name Row -->
                                    <div  id="ifhrms_id">
                                        <div class="col-12 col-md-3">
                                            <label for="name" class="form-label">IFHRMS<span
                                                    style="color: red;">*</span></label>
                                        </div>
                                        <div class="col-12 col-md-7">
                                            <input type="text" name="ifhrms" class="form-control" id="name"
                                                placeholder="Enter IFHRMS ID" value="{{ old('ifhrms') }}">
                                        </div>
                                    </div> --}}
                                        ...
                                        <div id="email_id_div">
                                            ...
                                            <input type="text" name="email_id" class="form-control" id="email_id"
                                                placeholder="Enter Email Id" value="{{ $result->email_id }}">
                                        </div>
                                        ...
                                        <div id="fax_div">
                                            ...
                                            <input type="text" name="fax" class="form-control" id="fax"
                                                placeholder="Enter Fax" value="{{ $result->fax }}">
                                        </div>
