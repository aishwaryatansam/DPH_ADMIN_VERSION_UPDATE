...
@section('content')
                        ...
                        <div class="col-lg-12 p-5" style="background-color: #ffffff; border-radius: 10px;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3 p-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="border p-3 rounded bg-light">
                                            {{ $result->is_post_vacant === 1 ? 'Yes' : 'No' }}</div>
                                    </div>
                                    <!-- Designation Type -->
                                    <div class="col-md-4">
                                        <div class="font-weight-bold text-secondary">Designation Type:</div>
                                        <div class="border p-3 rounded bg-light">{{ $result->contactType->name ?? '--' }}
                                        </div>
                                    </div>
                                    <!-- Designation -->
                                    <div class="col-md-4">
                                        <div class="font-weight-bold text-secondary">Designation:</div>
                                        <div class="border p-3 rounded bg-light">{{ $result->designation->name ?? '--' }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3 p-3">
                                    ...
                                    <!-- Qualification -->
                                    <div class="col-md-4">
                                        <div class="font-weight-bold text-secondary">Qualification:</div>
                                        <div class="border p-3 rounded bg-light">{{ $result->qualification ?? '--' }}</div>
                                    </div>
                                    <!-- Mobile Number -->
                                    <div class="col-md-4">
                                ...
                                <div class="row mb-3 p-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="border p-3 rounded bg-light">{{ $result->landline_number ?? '--' }}
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3 p-3">
                                    ...
                                    @if ($result->facility_id)
                                        <div class="col-md-4">
                                            <div class="font-weight-bold text-secondary">Facility Name:</div>
                                            <div class="border p-3 rounded bg-light">
                                                {{ $result->facility->facility_name ?? '--' }}</div>
                                        </div>
                                    @endif
                                    ...
                                    @if ($result->facility_id)
                                        <div class="col-md-4">
                                            <div class="font-weight-bold text-secondary">Facility Type:</div>
                                            <div class="border p-3 rounded bg-light">
                                                {{ $result->facility->facility_type->name ?? '--' }}</div>
                                        </div>
                                    @endif
                                ...
                                <div class="row mb-3 p-3">
                                    ...
                                    @if (
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="border p-3 rounded bg-light">{{ $result->block->name ?? '--' }}
                                            </div>
                                        </div>
                                    @endif
                                    <!-- PHC -->
    ...
    <script>
        ...
        function submitBulkRemarks(remarks) {
            fetch(`{{ url('approval/contact/bulk-action') }}`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        function submitRemarks() {
            ...
            if (isBulkAction) {
                ...
                fetch(`{{ url('approval/contact/') }}/${currentDocumentId}/${actionType}`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute(
    ...
    <script>
        ...
        function performAction(action, id) {
            fetch(`{{ url('approval/contact/') }}/${id}/${action}`, {
                    method: 'POST',
                    headers: {
