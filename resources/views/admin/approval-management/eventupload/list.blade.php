    ...
    <div class="container" style="margin-top: 90px;">
        <div class="container-fluid p-2" style="background-color: #f2f2f2;">
            <div class="d-flex justify-content-between align-items-center" style="padding-left: 20px; padding-right: 20px;">
                <h5 class="mb-0">Manage Event Upload</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0" style="background-color: #f2f2f2;">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Manage Event Upload</li>
                    </ol>
                </nav>
                ...
                <div class="container-fluid ps-4 bg-white py-4" style="border-radius: 8px;">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-lg-5">
                            <h4 class="card-title mb-5 text-primary text-start">Manage Event Upload</h4>
                            @if (isAdmin())
                                <div class="mb-5">
                                                ...
                                                @foreach ($results['paginatedResult'] as $result)
                                                    <tr>
                                                        ...
                                                        <td><a href="#" data-bs-toggle="modal"
                                                                data-bs-target="#approvalModa">{{ $result->model->event->name ?? '' }}</a>
                                                        </td>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end shadow-lg p-2"
                                                                    ...
                                                                    @if (isAdmin())
                                                                        ...
                                                                        <li>
                                                                            <a class="dropdown-item d-flex align-items-center"
                                                                                href="{{ route('event-upload.show', $result->model->id) }}"
                            ...
                            <div class="modal-content">
                                ...
                                <span class="mt-5 text-center">
                                    <h5 style="color: #6c757d;">Document Name: <span
                                            style="font-weight: bold; color: #1572e8;" id="document-title"></span></h5>
                                </span>
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        <div class="page-inner">
                                                                    ...
                                                                    <div class="tracking-list p-lg-5">
                                                                        ...
                                                                        <div class="tracking-item verified">
                                                                            ...
                                                                            <div class="tracking-content">
                                                                                ...
                                                                                <div
                                                                                    class="d-flex justify-content-between">
                                                                                    <div class="tracking-user">Verified
                                                                                        by:
                                                                                        State Verifier</div>
                                                                                    <span class="tracking-date">Date and
                                                                                        Time</span>
                                                                        ...
                                                                        <div class="tracking-item approved">
                                                                            ...
                                                                            <div class="tracking-content">
                                                                                ...
                                                                                <div
                                                                                    class="d-flex justify-content-between">
                                                                                    <div class="tracking-user">Approved
                                                                                        by:
                                                                                        HUD Approver</div>
                                                                                    <span class="tracking-date">Date and
                                                                                        Time</span>
                                                                        ...
                                                                        <div class="tracking-item pending">
                                                                            ...
                                                                            <div class="tracking-content">
                                                                                ...
                                                                                <div
                                                                                    class="d-flex justify-content-between">
                                                                                    <div id="modal-uploaded-by"
                                                                                        class="tracking-user">Uploaded
                                                                                        by:
                                                                                        HSC User</div>
                                                                                    <span class="tracking-date"
                                                                                        id="uploaded-by-date-time"></span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
