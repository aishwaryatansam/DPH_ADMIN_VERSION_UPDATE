    ...
    <div class="container" style="margin-top: 90px;">
        <div class="container-fluid p-2" style="background-color: #f2f2f2;">
            <div class="d-flex justify-content-between align-items-center" style="padding-left: 20px; padding-right: 20px;">
                <h5 class="mb-0">Manage Facility Profile</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0" style="background-color: #f2f2f2;">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Manage Facility Profile</li>
                    </ol>
                </nav>
                ...
                <div class="container-fluid ps-4 bg-white py-4" style="border-radius: 8px;">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-lg-5">
                            <h4 class="card-title mb-5 text-primary text-start">Manage Facility Profile</h4>
                            @if (isAdmin())
                                <div class="mb-5">
                            ...
                            {{-- @if ((isDistrict() || isHUD() || isBlock() || isPHC() || isHSC() || isState()) && isApprover())
                                <div class="mb-5">
                                    <small style="font-weight: bold; color: #888; margin-right: 10px;">Bulk Select:</small>
                                    <button id="approveBtn" class="btn btn-info" 
                                        onclick="performBulkAction('approve')">Approve</button>
                            ...
                            @if ((isDistrict() || isHUD() || isBlock() || isPHC() || isHSC() || isState()) && isVerifier())
                                <div class="mb-5">
                                    <small style="font-weight: bold; color: #888; margin-right: 10px;">Bulk Select:</small>
                                    <button id="verifyBtn" class="btn btn-secondary"
                                        onclick="performBulkAction('verify')">Verify</button>
                                                ...
                                                @foreach ($results as $result)
                                                    <tr>
                                                        ...
                                                        <td><a href="#" data-bs-toggle="modal"
                                                                data-bs-target="#approvalModa">{{ $result->model->facility_hierarchy->facility_name ?? '' }}</a>
                                                        </td>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end shadow-lg p-2"
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <li>
                                                                            <a class="dropdown-item d-flex align-items-center"
                                                                                href="{{ route('facility-profile.show', $result->model->id) }}"
                            ...
                            <div class="tab-pane fade mt-5" id="nav-Pushed" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <table class="data-table display table table-striped table-hover doc-table"
                                        ...
                                        <tbody>
                                            @if ($pushedDocs->isEmpty())
                                                <tr>
                                                    <td colspan="8" class="text-center">No Facility</td>
                                                </tr>
                                            @else
                                                @foreach ($pushedDocs as $result)
                                                    <tr>
                                                        <td><input type="checkbox"
                                                                class="form-check-input documentCheckbox"
                                                                value="{{ $result->id }}"></td>
                                                        <td><a href="#" data-bs-toggle="modal"
                                                                data-bs-target="#approvalModa">{{ $result->model->facility_hierarchy->name ?? '' }}</a>
                                                        </td>
                                                        <td>{{ $result->user->name ?? '' }}</td>
                                                        <td>{{ findProcessedBy($result->current_stage, $result->id) }}</td>
                                                        <td>
                                ...
                                <div class="table-responsive">
                                    <table class="data-table display table table-striped table-hover doc-table"
                                        ...
                                        <tbody>
                                            ...
                                            @else
                                                @foreach ($approvedDocs as $result)
                                                    <tr>
                                                        <td><input type="checkbox"
                                                                class="form-check-input documentCheckbox"
                                                                value="{{ $result->id }}"></td>
                                ...
                                <div class="table-responsive">
                                    <table class="data-table display table table-striped table-hover doc-table"
                                        ...
                                        <tbody>
                                            ...
                                            @else
                                                @foreach ($returnedDocs as $result)
                                                    <tr>
                                                        <td><input type="checkbox"
                                                                class="form-check-input documentCheckbox"
                                                                value="{{ $result->id }}"></td>
                                                        ...
                                                        <td>{{ $result->user->name ?? '' }}</td>
                                                        <td>{{ findProcessedBy($result->current_stage, $result->id) }}
                                                        </td>
                                                        <td>
                                                            {!! getStageBadge($result->current_stage) !!}
                                                        </td>
                                ...
                                <div class="table-responsive">
                                    <table class="data-table display table table-striped table-hover doc-table"
                                        ...
                                        <tbody>
                                            ...
                                            @else
                                                @foreach ($rejectedDocs as $result)
                                                    <tr>
                                                        <td><input type="checkbox"
                                                                class="form-check-input documentCheckbox"
                                                                value="{{ $result->id }}"></td>
